<html>
  ...
  <div id="doc3" class="yui-t7">
    ...
    ${h.form(h.url_for(action="event_create"), method="post")}
      <tr><td>Title</td><td>${h.textarea(name="title", rows=1, cols=80, content="")}<br />* Required</td></tr>
      <tr><td>Description</td><td>${h.textarea(name="description", rows=7, cols=80, content="")}<br />* Required</td></tr>
      <tr><td>Start Date</td><td>Year: ${h.select("start_year", None, c.years)} Month: ${h.select("start_month", None, c.months)} Day: ${h.select("start_day", None, c.days)} Hour: ${h.select("start_hour", None, c.hours)} Minute: ${h.select("start_minute", None, c.minutes)} Second: ${h.select("start_second", None, c.seconds)}<br />* Required</td></tr>
